...
Em qual idioma o Gemini deve responder por padrão? Opções sugeridas: português, inglês, ou outro (texto livre).

**Resposta:** (ainda não respondido)

## Como quer ser chamado

Nome ou apelido que o Gemini deve usar ao se referir ao usuário nas respostas.
...
- [MIND.md](MIND.md)
- [GEMINI.md](GEMINI.md) — regras de trabalho (diferente disto aqui, que é configuração inicial)
